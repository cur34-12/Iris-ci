                ...
                <div class="page-content"> 
                    ...
                    <div class="page-bar">
                        <ul class="page-breadcrumb">
                            <li>
                                <a><i class="fa fa-calendar fa-fw"></i> <?php echo lang('settings_cal_name') ?> </a> 
                            </li> 
                        </ul>
                                        ...
                                        <div class="col-md-12 col-sm-12"> 
											...
											<div class="form-group">
												...
												<div class="form-group"> 
													...
													<select class="form-control" name="cal_language" id="language">
														...
														<option value="ar" <?php if($userinfo->lang =='ar') { echo "SELECTED";}?>><?php echo lang('lang_arabic'); ?></option>
														...
														<option value="id" <?php if($userinfo->lang =='id') { echo "SELECTED";}?>><?php echo lang('lang_indonesian'); ?></option>
											...
											<div class="form-group">
												...
												<select class="form-control" name="cal_defaultview" id="cal_defaultview">
													...
													<option value="agendaList" <?php if($userinfo->cal_defaultview =='agendaList'){ echo "SELECTED";}?> ><?php echo lang('cal_defaultview_agendalist'); ?></option> 
													<option value="agendalistDay" <?php if($userinfo->cal_defaultview =='agendalistDay'){ echo "SELECTED";}?> ><?php echo lang('cal_defaultview_agendalist_day'); ?></option> 										
													<option value="agendalistWeek" <?php if($userinfo->cal_defaultview =='agendalistWeek'){ echo "SELECTED";}?> ><?php echo lang('cal_defaultview_agendalist_week'); ?></option>
													<option value="agendalistMonth" <?php if($userinfo->cal_defaultview =='agendalistMonth'){ echo "SELECTED";}?> ><?php echo lang('cal_defaultview_agendalist_month'); ?></option> 							
													<option value="agendalistYear" <?php if($userinfo->cal_defaultview =='agendalistYear'){ echo "SELECTED";}?> ><?php echo lang('cal_defaultview_agendalist_year'); ?></option>
													<option value="list" <?php if($userinfo->cal_defaultview =='list'){ echo "SELECTED";}?> ><?php echo lang('cal_defaultview_list'); ?></option>
													<option value="listDay" <?php if($userinfo->cal_defaultview =='listDay'){ echo "SELECTED";}?> ><?php echo lang('cal_defaultview_listday'); ?></option> 													
													<option value="listWeek" <?php if($userinfo->cal_defaultview =='listWeek'){ echo "SELECTED";}?> ><?php echo lang('cal_defaultview_listweek'); ?></option> 													<option value="listMonth" <?php if($userinfo->cal_defaultview =='listMonth'){ echo "SELECTED";}?> ><?php echo lang('cal_defaultview_listmonth'); ?></option> 
													<option value="listYear" <?php if($userinfo->cal_defaultview =='listYear'){ echo "SELECTED";}?> ><?php echo lang('cal_defaultview_listyear'); ?></option>  												
												</select>
											...
											<div class="form-group">
												<label><?php echo lang('cal_slotlabelformat') ?></label>
												<input class="form-control" type="text" name="cal_slotlabelformat" id="cal_slotlabelformat" value="<?php echo set_value('cal_slotlabelformat', $userinfo->cal_slotlabelformat); ?>" />
												<p class="help-block"><?php echo form_error('cal_slotlabelformat') ?></p>
											</div>												
