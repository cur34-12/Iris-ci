									...
									<div class="row">
										<div class="col-md-12 col-lg-12"> 
											...
											<?php echo form_open('admin/settings', array('class' => 'form-hoziontal', 'id' => 'form_settings', 'name' => 'form_settings', 'role' => 'form' )); ?>   
												...
												<div class="form-group">   
													<label class="control-label" for="inputAPIKEY"><?php echo lang('api_google'); ?> <a href="https://developers.google.com/maps/documentation/javascript/get-api-key#key" target="_blank">Reference here</a></label> 
