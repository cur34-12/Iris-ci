											...
											<?php echo form_open('admin/settings/calendar_settings', array('class' => 'form-horizontal', 'id' => 'form_cal', 'name' => 'form_cal'));	?> 
												...
												<div class="form-group">
													...
													<select class="form-control" name="cal_defaultview" id="cal_defaultview">
														...
														<option value="agendaList" <?php if($defaultview =='agendaList'){ echo "SELECTED";}?> ><?php echo lang('cal_defaultview_agendalist'); ?></option> 
														<option value="agendalistDay" <?php if($defaultview =='agendalistDay'){ echo "SELECTED";}?> ><?php echo lang('cal_defaultview_agendalist_day'); ?></option>									
														<option value="agendalistWeek" <?php if($defaultview =='agendalistWeek'){ echo "SELECTED";}?> ><?php echo lang('cal_defaultview_agendalist_week'); ?></option>
														<option value="agendalistMonth" <?php if($defaultview =='agendalistMonth'){ echo "SELECTED";}?> ><?php echo lang('cal_defaultview_agendalist_month'); ?></option>	
														<option value="agendalistYear" <?php if($defaultview =='agendalistYear'){ echo "SELECTED";}?> ><?php echo lang('cal_defaultview_agendalist_year'); ?></option>
														<option value="list" <?php if($defaultview =='list'){ echo "SELECTED";}?> ><?php echo lang('cal_defaultview_list'); ?></option>
														<option value="listDay" <?php if($defaultview =='listDay'){ echo "SELECTED";}?> ><?php echo lang('cal_defaultview_listday'); ?></option> 													
														<option value="listWeek" <?php if($defaultview =='listWeek'){ echo "SELECTED";}?> ><?php echo lang('cal_defaultview_listweek'); ?></option> 													
														<option value="listMonth" <?php if($defaultview =='listMonth'){ echo "SELECTED";}?> ><?php echo lang('cal_defaultview_listmonth'); ?></option> 
														<option value="listYear" <?php if($defaultview =='listYear'){ echo "SELECTED";}?> ><?php echo lang('cal_defaultview_listyear'); ?></option>  														
													</select>
												...
												<div class="form-group">
													...
													<input class="form-control" type="text" name="cal_slotlabelformat" id="cal_slotlabelformat" value="<?php echo set_value('cal_slotlabelformat', $slotlabelformat); ?>" />
