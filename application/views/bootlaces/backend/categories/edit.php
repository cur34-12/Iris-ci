                            ...
                            <div class="pages"> 
                                ...
                                <div class="panel-body">
									<div class="row">
										...
										<?php echo form_open('profile/categories/edit/'.$editcategory->category_id, array('id' => 'form_edit', 'name' => 'form_edit', 'role' => 'form' )); ?>  
	...
	<div class="modal fade" id="del_<?php echo $editcategory->category_id ?>" tabindex="-1" role="dialog" aria-labelledby="delete" aria-hidden="true">
	  <div class="modal-dialog">
		<div class="modal-content">
			...
			<?php echo form_open('admin/categories/del/'.$editcategory->category_id, array('id' => 'form_del', 'name' => 'form_del', 'role' => 'form' )); ?>  
			<div class="modal-body"> 
