	...
	<tbody>
		<?php foreach($issues as $issue) : ?>
			<tr>
					...
					<?php echo "<td><script>moment('<?php echo $issue['reported_date'] ?>').format('DD-MM-YYYY');</script></td>"; ?>
					<?php echo "<td><script>moment('<?php echo $issue['resolution_date'] ?>').format('DD-MM-YYYY');</script></td>"; ?>
