...
<table class="table table-striped table-hover ">
	...
	<tr><td style="font-weight: bold">Reported By</td><td><?php echo $issue['iss_reported_id']; ?></td></tr>
	...
	<tr><td style="font-weight: bold">Created By</td><td><?php echo $issue['iss_creator_idl']; ?></td></tr>
</table>
<hr />
...
<!--Edit Button-->
<a class="btn btn-info" role="button" href="<?php echo site_url('/vissues/edit/'. $issue['iss_title']); ?>">Edit Issue</a>

<!--Delete Button (as form to protect against abuse)-->
<?php $attributes = array('class' => 'form-inline', 'style' => 'display: inline;'); ?>
<?php echo form_open('/issues/delete/'.$issue['iss_title'], $attributes); ?>
