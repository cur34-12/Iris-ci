...
<table id="content" class="table table-striped table-hover dataTable">
	...
	<tbody>
		<?php foreach($vehicles as $vehicle) : ?>
			<tr>
				<td style="text-transform: uppercase;"><a href="<?php echo site_url('/equipment/'. $vehicle['veh_eq_id']); ?>"><?php echo $vehicle['veh_name']; ?></a></td>
				...
				<td><a class="btn btn-primary btn-sm" role="button"  href="vehicles/view/<?php echo $vehicle['veh_id']; ?>">Details</a></td>
