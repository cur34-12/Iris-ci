...
class Fullcalendar_admin_model extends CI_Model {
    ...
    */
    ...
    /**
    * jsonResources - Get members events from the database
    ...
    */   
	public function jsonResources($user)    {        
		...
		$events = $this->db->select('*')->from($this->table_category)->order_by('category_id', 'desc')->get(); 
       ...
       echo json_encode($jsonresources);
    }
