...
*/
$autoload['model'] = array('Vehicle_model','Locations_model','Equipment_model','Issues_model','User_model','Loans_model','Loangroups_model','Suppliers_model','Unitmembers_model');